const CACHE='musicandbeats-v6.1';
const ASSETS=['./','./index.html','./styles.css','./v4.css','./v5.css','./v6.css','./v6-patch.css','./app.js','./workflow-fixes.js','./v4-fixes.js','./v5-fixes.js','./v5-hotfix.js','./v6.js','./v6-patch.js','./recorder-worklet.js','./manifest.webmanifest','./icon.svg','./assets/instruments/grand-piano.svg','./assets/instruments/electric-piano.svg','./assets/instruments/organ.svg','./assets/instruments/synth.svg','./assets/instruments/pad.svg','./assets/instruments/bass.svg','./assets/instruments/guitar-rig.svg'];
